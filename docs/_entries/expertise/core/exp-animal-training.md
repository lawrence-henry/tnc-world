...
!!! abstract ""
    ...
    **Prerequisites:** 
    ...
    === "Advanced"
        **Pack Leader.** You can train one animal of High Threat, alternatively adding one additional animal for every threat level at Moderate or below. In combat, you may give commands to all of your animals as part of the same action.
    === "Expert"
        **Alpha Bond.** You can train one animal of Nightmare Threat, alternatively adding one additional animal for every threat level at High or below. You no longer need to issue verbal commands; your animal companions follow your intent through subtle cues. Additionally, trained companion animals gain an additional 2d6 Health.
