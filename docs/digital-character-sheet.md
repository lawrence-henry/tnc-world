...
<form class="charsheet">
  <header>
    ...
    <section class="misc">
      <ul>
        <li>
          <label for="background">Background & Level</label><input name="background" placeholder="Athlete 1" />
        </li>
        <li>
          <label for="playername">Player Name</label><input name="playername" placeholder="Player McPlayerFace" />
        </li>
        <li>
          <label for="survivorpoints">Survivor Points</label><input name="survivorpoints" placeholder="2" />
        </li>
        <li>
          <label for="chancepool">Chance Pool</label><input name="chancepool" placeholder="6" />
        </li>
        <li>
          <label for="infectionlevel">Infection Level</label><input name="infectionlevel" placeholder="0" />
        </li>
        <li>
      ...
      <section class="attributes">
        <div class="scores">
          <ul>
            <li>
              <div class="score">
                <label for="mightscore">Might</label><input name="mightscore" value="0" />
              </div>
              <div class="modifier">
                <input name="mightprime" type="checkbox" />
              </div>
            </li>
            <li>
              <div class="score">
                <label for="reflexesscore">Reflexes</label><input name="reflexesscore" value="0" />
              </div>
              <div class="modifier">
                <input name="reflexesprime" type="checkbox" />
              </div>
            </li>
            <li>
              <div class="score">
                <label for="constitutionscore">Constitution</label><input name="constitutionscore" value="0" />
              </div>
              <div class="modifier">
                <input name="constitutionprime" type="checkbox" />
              </div>
            </li>
            <li>
              <div class="score">
                <label for="witsscore">Wits</label><input name="witsscore" value="0" />
              </div>
              <div class="modifier">
                <input name="witsprime" type="checkbox" />
              </div>
            </li>
            <li>
              <div class="score">
                <label for="willpowerscore">Willpower</label><input name="willpowerscore" value="0" />
              </div>
              <div class="modifier">
                <input name="willpowerprime" type="checkbox" />
              </div>
            </li>
            <li>
              <div class="score">
                <label for="perceptionscore">Perception</label><input name="perceptionscore" value="0" />
              </div>
              <div class="modifier">
                <input name="perceptionprime" type="checkbox" />
              </div>
            </li>
          </ul>
        </div>
        ...
        <div class="attr-applications">
          <div class="saves list-section box">
            <ul>
              <li><textarea placeholder="Might Talents" style="height:5em;"></textarea></li>
              <li><textarea placeholder="Reflexes Talents" style="height:5em;"></textarea></li>
              <li><textarea placeholder="Constitution Talents" style="height:5em;"></textarea></li>
              <li><textarea placeholder="Wits Talents" style="height:5em;"></textarea></li>
              <li><textarea placeholder="Willpower Talents" style="height:5em;"></textarea></li>
              <li><textarea placeholder="Perception Talents" style="height:5em;"></textarea></li>
            </ul>
            <div class="label"> Talents
            </div>
            </div>
            </div>
           </section>
      <div class="otherprofs box textblock">
        <label for="otherprofs">Conditions</label><textarea name="otherprofs"></textarea>
      </div>
    </section>
<section>
  <section class="combat">
    <div class="armorclass">
      <div>
      <label for"ac">Defense</label><input name="ac" placeholder="9" type="text" />
    </div>
    </div>
    <div class="initiative">
      <div>
        <label for="initiative">Damage Resist</label><input name="initiative" placeholder="+0" type="text" />
      </div>
    </div>
    <div class="speed">
      <div>
        <label for="speed">Speed</label><input name="speed" placeholder="10yd" type="text" />
      </div>
    </div>
    <div class="hp">
      <div class="regular">
        <div class="max">
          <label for="maxhp">Health Maximum</label><input name="maxhp" placeholder="10" type="text" />
        </div>
        <div class="current">
          <label for="currenthp">Current Health</label><input name="currenthp" type="text" />
        </div>
      </div>
      <div class="temporary">
        <label for="temphp">Armor Type</label><input name="temphp" type="text" />
      </div>
    </div>
  </section>
  <section class="attacksandspellcasting">
    <div>
      <label>Attacks & Weapons</label>
      <table>
        <thead>
          <tr>
            <th>Name</th>
            <th>Atk Bonus</th>            <th>Damage/Type</th>
          </tr>
        </thead>
        <tbody>
          <tr>
 ...
 <section class="equipment">
    ...
    <label>Equipment</label>
          <div class="money">
            <ul>
              <li>
                <label for="cp">RP</label><input name="cp" />
              </li>
          </div>
      ...
      <section class="flavor">
        <div class="personality">
          <label for="personality">Weapon Group Training</label><textarea name="personality"></textarea>
        </div>
        <div class="ideals">
          <label for="ideals">Armor Training</label><textarea name="ideals"></textarea>
        </div>
        <div class="bonds">
          <label for="bonds">Special Ability Mutations</label><textarea name="bonds"></textarea>
        </div>
        <div class="flaws">
          <label for="flaws">Connections</label><textarea name="flaws"></textarea>
        </div>
      </section>
      <section class="features">
        <div>
          <label for="features">Expertise & Specialization</label><textarea name="features"></textarea>
        </div>
      </section>
    </section>
